...
//  Freeze Tab Highlight when on that section
function showGreen() {
...
// Highlights when mouse moves over tab.
function blueBlack() {
	blue.style.backgroundColor = 'black';
	blue.style.color = 'lightgrey';
	red.style.backgroundColor = 'white';
...
blue.addEventListener('mousemove', blueBlack);
green.addEventListener('mousemove', greenBlack);
red.addEventListener('mousemove', redBlack);
